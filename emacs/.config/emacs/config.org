#+Title: Mashood's Gnu Emacs Config
#+Author: Mashood ur Rehman Rana
...
- [[#put-this-in-config][Put this in config]]
...
This snippet adds a hook to org-mode buffers so that mashi/org-babel-tangle-config gets executed each time such a buffer gets saved.
This function checks to see if the file being saved is the Emacs.org file you’re looking at right now, and if so,
automatically exports the configuration here to the associated output files.
#+begin_src emacs-lisp
    (defun mashi/org-babel-tangle-config ()
    ...
    (add-hook 'org-mode-hook (lambda () (add-hook 'after-save-hook #'mashi/org-babel-tangle-config)))
#+end_src
...
#+begin_src emacs-lisp
    (use-package evil
      ...
      (evil-want-C-i-jump t)        ;; Enables C-i jump
    ...
    (define-key evil-insert-state-map (kbd "C-k") 'vertico-previous)
    (define-key evil-insert-state-map (kbd "C-h") 'evil-delete-backward-char-and-join)
    ; (define-key evil-normal-state-map (kbd "<escape>") 'minibuffer-keyboard-quit)
#+end_src
...
#+begin_src emacs-lisp
    (use-package general
      ...
      (general-create-definer mashi/leader-keys
      ...
      (mashi/leader-keys
       ...
       "i s" '(consult-yasnippet :wk "Consult Snippet")
       "i l" '(org-cliplink :wk "Org Cliplink"))

      (mashi/leader-keys
       "l" '(:ignore t :wk "LSP")
       "l a" '(lsp-ui-sideline-apply-code-actions :wk "Code Actions")
       "l f" '(lsp-format-buffer :wk "Format Buffer")
       "l F" '(lsp-format-region :wk "Format Region")
       "l r" '(lsp-find-references :wk "Find References")
       "l R" '(lsp-ui-peek-find-references :wk "Peek Find References"))
...
#+begin_src emacs-lisp
    (use-package emacs
      ...
      (save-place-mode 1) ;; Save cursor position of each file
...
Project interaction library for Emacs.
      ...
      (use-package projectile
        ...
        (projectile-project-search-path '(("~/hdd/projects/" . 1))))
...
#+begin_src emacs-lisp
    (use-package lsp-mode
      :hook ((c-ts-mode c++-ts-mode cmake-ts-mode
                        ...
                        gdscript-mode python-ts-mode)
             . lsp))  ;; Autostart lsp servers for a given mode
#+end_src
...
*** Lsp-ui
#+begin_src emacs-lisp
    ; TODO lsp-ui-doc{-frame} bindings
    (use-package lsp-ui
      :after lsp-mode
      :bind
...
#+begin_src emacs-lisp
  (use-package emmet-mode
    :hook ((html-mode mhtml-mode web-mode css-ts-mode) . emmet-mode)
    :config
...
#+begin_src emacs-lisp
  (use-package treesit-auto
    ...
    :config
    (setq treesit-font-lock-level 4) ;; Level 4 adds everything
    ...
    ;; Treesitter modes that currently have issues
...
** Try
Try out Emacs packages without downloading them to main emacs config (downloads them to /tmp directory)
#+begin_src emacs-lisp
    (use-package try)
#+end_src
